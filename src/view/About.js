      ...
      <section className="marketplace-section mb-50">
        ...
        <div className="container-fluid no-padding">
          <div className="row">
            <div className="col-md-4">
              <div className="main-heading-title bg-partenaires">
                <h3>Your Colleagues - Meet the SAC Team</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="team-section">
          <div className="container">
            <OwlCarousel className="team-carousel" {...options3}>
              <div className="item">
                <div className="card-details">
                  <div className="media">
                    <div className="media-left">
                      <img alt="Markus-Seeberger" className="img-fluid" src="assets/img/Markus-Seeberger.jpg" />
                    </div>

                    <div className="media-body">
                      <h3>Dr. Markus Seeberger</h3>
                      <p><strong>This project included developing a
                        positioning strategy for a new brand, identifying a suitable target group,
                        and
                        specifying detailed product attributes. </strong></p>
                    </div>
                  </div>

                  <p>Finally, we identified several additional
                    business models around the vehicle and developed a transparent business case that
                    ...
                    project special. In other projects I analyzed the automotive smart charging market
                    and entry strategies in the automotive operating system market for an IT supplier.
                  </p>

                  <p>In other projects, I got to work on the product strategy of a Chinese EV newcomer,
                    several EV battery recycling projects, as well as the elaboration of product
                    strategies for several companies – from startup to established OEM. Being part of a
                    firm with a such diversified portfolio has in fact never stopped to be thrilling and
              ...
              <div className="item">
                <div className="card-details">
                  <div className="media">
                    <div className="media-left">
                      <img alt="Karam-Chehade" className="img-fluid" src="assets/img/Karam-Chehade.jpg" />
                    </div>
                    <div className="media-body">
                      <h3>Karam Chehade</h3>
                      <p><strong>One of my first projects at SAC was with an OEM startup who intended to
                        launch a
                        battery electric vehicle in Europe and China. </strong></p>
                    </div>
                  </div>
                  <p>When I started my position as a consultant at SAC, I was immediately posted on a
                    ...
                    professionalism, depth of analysis but also automotive expertise which were played
                  ...
                  <p>A focus on international projects, most current topics, a broad automotive expertise,
                    the passion of all employees for automobiles, and an amazing team spirit make
                    working at SAC an unique experience. I also would like to mention the active company
              ...
              <div className="item">
                <div className="card-details">
                  <div className="media">
                    <div className="media-left">
                      <img alt="Tobias-Blucher" className="img-fluid" src="assets/img/Tobias-Blucher.jpg" />
                    </div>
                    <div className="media-body">
                      <h3>Tobias Blücher</h3>
                      <p><strong>Soon after joining SAC, I was able to gain my first experiences as a
                        consultant
                        with SAC.</strong></p>
                    </div>
                  </div>
                  <p>
                    In my first project we advised a Chinese OEM on the development of a brand and portfolio
                    strategy. This was the perfect opportunity to bring in my automotive industry expertise
                    in brand and product strategy. On this project, I was able to manage and execute my own
                    workflows, which I think is the perfect way for a steep learning curve. Most exciting
                    part of the project was to present the findings and strategy recommendations to the
                    client’s top management.</p>
                  <p>The team is truly committed to SAC’s motto of “Inspiring Leaders”, which leads the drive
                    to achieve excellence in our daily work tasks. This creates a working environment that
                    allows me to bring out the best of myself and that encourages my personal growth and
                    ambition. In addition to the top consulting methods and the automotive expertise in the
                    company, what I appreciate most about SAC is the team spirit, where we always help each
                    other. This team spirit is not only embraced in the daily work routine, but also at the
                    company’s team events such as the summer camp or at the Wiesn.</p>
                  <p>I hold a master’s degree in economics from the Humboldt University of Berlin and a
                    bachelor’s degree in economics from the University of Freiburg. Prior to joining SAC, I
                    was able to gain professional experience in venture capital and investment banking. In
                    my free time, I like to go on road bike trips through the Munich countryside or visit
                    Munich’s numerous “Biergärten” and “Wirtshäuser” to enjoy a few beers and delicious
                    local food. In addition to that I am a huge sports fan and my favorite sports to watch
              ...
              <div className="item">
                <div className="card-details">
                  <div className="media">
                    <div className="media-left">
                      <img alt="Torsten-T-Resack" className="img-fluid" src="assets/img/Torsten-T-Resack.jpg" />
                    </div>
                    <div className="media-body">
                      <h3>Torsten T. Resack</h3>
                      <p><strong>My start at SAC before 15 months was what I would wish for any new
                        consultant:</strong></p>
                    </div>
                  </div>
                  <p> after a
                    very warm welcome by my new boss, switching from “Sie” to “Du”, receiving my new mobile
                    device and company laptop, and a short introduction to SAC, 2 hours after entering the
                    SAC office I was already in my first client call. A start like a sports car. Great fit
                    to an automotive consultancy! Sure, a few days later a comprehensive on-boarding
                    followed but from the very first moment I was part of the project team and worked for my
                    first SAC project.</p>
                  <p>And while this project was automotive related it was not a “pure” automotive project: the
                    project’s goal was an evaluation of the German EV-battery recycling market for a
                    recycling company and an analysis of the EV-battery recycling strategy of the German
                    OEMs. This project represents SAC’s project landscape: the projects are not “only” for
                    automotive manufacturers, but always have an automotive connection. My second project
                    was centered around the mobility services market in China, and afterwards I worked for
                    an Asian telecommunications company that wanted to enter the market for automotive
                    applications to a greater extent. Only the fourth project was for a “real” car
                    manufacturer.</p>
                  <p>That’s what I like about SAC. It’s all about cars, and yet the variety of projects is
                    extremely large. The fact that 2/3 of our customers come from abroad makes the work here
                    very exciting for me. We have a great atmosphere amongst our team and I am very thankful
                    for what I learned in my short time being here from my colleagues and from my automotive
                    enthusiastic boss Martin.</p>
                  <p>I am currently working on a general MBA, that I will finish in December 2022. Before
                    moving to Munich and my start at SAC I worked for another consultancy boutique for 3
                    years and lived in Frankfurt. Before being a consultant I worked as protestant pastor,
                    most recently in Jerusalem. In my spare time I love mountaineering in summer as in
