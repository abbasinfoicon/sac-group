$(document).ready(function () {
	var previous = document.getElementById("menu14"); //The last opened menu, "menu14" by default since it is opened on page load
	...
	var delay = function (elem, callback) { //Delay the execution of the "callback" argument on the "elem" argument
		...
		}, 0); //Time in milliseconds before the timer triggers
	...
	$(".clicky").click(function () {
		openMenu(document.getElementById("menu14"));
		previous = document.getElementById("menu14");
	});
